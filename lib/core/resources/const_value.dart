...
class ConstListValues {
  static const List<OnBoardingModel> listOnBoardingImageModel = [
    OnBoardingModel(
      ...
      image: AssetsValuesManger.konBoardingImage1,
    ),
    OnBoardingModel(
      text: ConstValue.kOnBoardingText2,
      image: AssetsValuesManger.konBoardingImage2,
    ),
    OnBoardingModel(
      text: ConstValue.kOnBoardingText3,
      image: AssetsValuesManger.konBoardingImage3,
    ),
    OnBoardingModel(
      text: ConstValue.kOnBoardingText4,
      image: AssetsValuesManger.konBoardingImage4,
    ),
    OnBoardingModel(
      text: ConstValue.kOnBoardingText5,
      image: AssetsValuesManger.konBoardingImage5,
    ),
  ];
